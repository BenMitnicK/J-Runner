...
namespace JRunner
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "J-Runner v" + StaticVersion.Betaversion + "." + StaticVersion.version + " " + "Modified by BenMitnicK"; //+ " Beta (" + StaticVersion.Build + ")";
        ...
        private void printstartuptext()
        {
            ...
            Console.Write("J-Runner v{0}.{1} ", StaticVersion.Betaversion, StaticVersion.version);
        ...
        private void phatCRQSBInstallToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            mylist.Add("/common/Pics/phat_install_qsb.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }

        private void phatCRToolStripMenuItem_Click(object sender, EventArgs e)
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/tx_revc_phat_rgh1.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/tx_revc_phat_rgh2.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/slim_install_qsb.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/tx_revc_slim.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/Corona250_wires.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/cr3lite.png");
            mylist.Add("/common/Pics/coronaguide.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/slim_install_diagram_final.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/phat_install_diagram_final.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/nandxphat.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/nandxCorona.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/nandxslim.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/nandxUSB.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/ck3iCOM.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/RJTAG-1.jpg");
            mylist.Add("/common/Pics/RJTAG-2.jpg");
            mylist.Add("/common/Pics/RJTAG-3.jpg");
            mylist.Add("/common/Pics/RJTAG-4.jpg");
            mylist.Add("/common/Pics/RJTAG-5.jpg");
            mylist.Add("/common/Pics/RJTAG-6.jpg");
            mylist.Add("/common/Pics/RJTAG-7.jpg");
            mylist.Add("/common/Pics/RJTAG-8.jpg");
            mylist.Add("/common/Pics/RJTAG-9.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/xenon1.jpg");
            mylist.Add("/common/Pics/xenon2.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/non_xenon1.jpg");
            mylist.Add("/common/Pics/non_xenon2.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/bootloader.png");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/rgh_1.2.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/dgx_wires.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }

        private void coronaV3456ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/S-RGH_Corona_V3.4.5.6.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/muffin_trinity.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        private void modelGuideToolStripMenuItem_Click(object sender, EventArgs e)
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/coronaguide.jpg");
            mylist.Add("/common/Pics/Xbox360_Model_Guide.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }

        private void topPowerGuideToolStripMenuItem_Click(object sender, EventArgs e)
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/xbox_360_slim_mainboard_power sources_top.jpg");
            mylist.Add("/common/Pics/Xbox360_Model_Guide.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/48crystal.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
        ...
        {
            List<string> mylist = new List<string>();
            mylist.Add("/common/Pics/muffin_corona.jpg");
            PictureViewer PicView = new PictureViewer(mylist);
            PicView.Show();
        }
    }
